...
class inmuebles(models.Model):
    ...
    estacionamiento_cajones = models.IntegerField(null=True, blank=True)
    ...
    año_contruccion = models.IntegerField(null=True, blank=True)
    garaje = models.BooleanField(null=True, blank=True)
    terraza =  models.BooleanField(null=True, blank=True)
    alberca =  models.BooleanField(null=True, blank=True)
    cocina =  models.BooleanField(null=True, blank=True)
    amueblado = models.BooleanField(null=True, blank=True)
    cuarto_lavado =models.BooleanField(null=True, blank=True)
    ...
    restaurante_bar=models.BooleanField(null=True, blank=True)
    sala_cine = models.BooleanField(null=True, blank=True)
    salon_estudio = models.BooleanField(null=True, blank=True)
    area_comun = models.BooleanField(null=True, blank=True)
    sala_juegos = models.BooleanField(null=True, blank=True)
    salon_eventos = models.BooleanField(null=True, blank=True)
    espacio_deportivo = models.BooleanField(null=True, blank=True)
    busniess_center = models.BooleanField(null=True, blank=True)
    roof_garden = models.BooleanField(null=True, blank=True)
    otroA = models.BooleanField(null=True, blank=True)
    internet  = models.BooleanField(null=True, blank=True)
    electricidad  = models.BooleanField(null=True, blank=True)    
    agua_potable = models.BooleanField(null=True, blank=True)
    televisionCable = models.BooleanField(null=True, blank=True)
    gas = models.BooleanField(null=True, blank=True)
    lineaTelefonica = models.BooleanField(null=True, blank=True)
    drenaje = models.BooleanField(null=True, blank=True)
    seguridad = models.BooleanField(null=True, blank=True)
    camarasSeguridad  = models.BooleanField(null=True, blank=True)
    area_juegos = models.BooleanField(null=True, blank=True)
